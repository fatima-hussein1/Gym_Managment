...
Partial Class FrmChangePassword
    ...
    Private Sub InitializeComponent()
        ...
        ToggleShowPassword = New Guna.UI2.WinForms.Guna2ToggleSwitch()
        PiczoomPass1 = New Guna.UI2.WinForms.Guna2PictureBox()
        PiczoomPass2 = New Guna.UI2.WinForms.Guna2PictureBox()
        ...
        ' TxtUserName
        ' 
        TxtUserName.BorderColor = Color.FromArgb(CByte(234), CByte(153), CByte(149))
        ...
        ' TxtOldPass
        ' 
        TxtOldPass.BorderColor = Color.FromArgb(CByte(234), CByte(153), CByte(149))
        TxtOldPass.BorderRadius = 6
        ...
        ' TxtNewPass
        ' 
        TxtNewPass.BorderColor = Color.FromArgb(CByte(234), CByte(153), CByte(149))
        TxtNewPass.BorderRadius = 6
        ...
        ToggleShowPassword.TabIndex = 101
        ToggleShowPassword.UncheckedState.BorderColor = Color.FromArgb(CByte(234), CByte(153), CByte(149))
        ToggleShowPassword.UncheckedState.BorderThickness = 2
        ToggleShowPassword.UncheckedState.FillColor = Color.FromArgb(CByte(0), CByte(9), CByte(43))
        ToggleShowPassword.UncheckedState.InnerColor = Color.FromArgb(CByte(234), CByte(153), CByte(149))
        ' 
        ' PiczoomPass1
        ' 
    ...
    Friend WithEvents ToggleShowPassword As Guna.UI2.WinForms.Guna2ToggleSwitch
    Friend WithEvents PiczoomPass1 As Guna.UI2.WinForms.Guna2PictureBox
    Friend WithEvents PiczoomPass2 As Guna.UI2.WinForms.Guna2PictureBox
